...
export default function Dashboard() {
  ...
  return (
    <Layout>
      ...
      <div className="min-h-[480px] bg-[linear-gradient(111.12deg,_#176257_-7.37%,_rgba(23,_98,_87,_0)_53.44%),radial-gradient(25.07%_77.97%_at_86.32%_50.11%,_#458178_0%,_#004b40_100%)] bg-blend-multiply"></div>
      <div className="max-w-screen-xl mx-auto mt-[-315px]">
        <h1 className="text-aw-50 mb-8 text-4xl font-bold">
          Say hi Ismail 👋 this is your dashboard
        </h1>
        <Tab.Group>
          <Tab.List className="flex max-w-lg">
            {TAB_MENU.map((item) => (
              <Tab
                ...
                className={({ selected }) =>
                  classNames(
                    'w-full text-go-300 py-2.5 text-sm font-bold leading-5 border-b-2 border-go-100 focus:outline-none',
                    selected ? 'text-aw-50 border-b-4 border-aw-50' : null
                  )
                }
              >
                {item.name}
          ...
          <Tab.Panels className="mt-2">
            <Tab.Panel className="rounded-xl focus:outline-none">
              <div className="mt-12 mb-6">
                <h2 className="text-aw-50 mb-1 text-2xl font-bold tracking-[-0.8px]">
                  Purchased Products List
                </h2>
                <p className="text-aw-50 text-sm tracking-[-0.5px]">
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                      <thead className="bg-gray-50">
                        <tr>
                          <th
                            scope="col"
                            className="text-go-700 sm:pl-6 py-6 pl-4 pr-3 text-sm font-semibold tracking-[-0.4px] text-left"
                          >
                            Product
                          </th>
                          <th
                            scope="col"
                            className="text-go-700 px-3 py-6 text-sm font-semibold tracking-[-0.4px] text-left"
                          >
                            About
                          </th>
                          <th
                          ...
                          <th
                            scope="col"
                            className="text-go-700 py-3.5 pl-3 pr-4 sm:pr-6 text-sm font-semibold tracking-[-0.4px]"
                          >
                            Download
                          </th>
                        </tr>
                      ...
                      <tbody className="divide-y divide-gray-200 bg-white">
                        {PRODUCT_LIST.map((item) => (
                          <tr key={item.email}>
                            ...
                            <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                              <span className="inline-flex items-center justify-center bg-white text-go-700 px-2.5 py-0.5 text-sm font-medium tracking-[-0.5px] leading-none border border-[#dadcff] rounded-full">
                                {item.version}
                              </span>
                            </td>
                            <td className="whitespace-nowrap px-3 py-4 text-sm font-medium tracking-[-0.5px] text-go-700">
                              <div className="inline-flex items-center gap-3">
                                <span className="inline-flex items-center justify-center w-10 h-10 bg-go-50 rounded-full">
                                  <Documents className="w-5 h-5 text-go-700" />
                                </span>
                                {item.licence}
                              </div>
                            </td>
                            <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-sm font-medium sm:pr-6">
                              <a
                                href="#"
                                className="flex items-center justify-center text-go-700 text-center"
                              >
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                      ...
                      <tbody className="divide-y divide-gray-200 bg-white">
                        {BILLING_LIST.map((item) => (
                          <tr key={item.id}>
                            <td className="text-gray-800 text-base font-medium tracking-[-0.5px] py-6 pl-4 pr-3 sm:pl-6 whitespace-nowrap">
                              {item.productName}
                            </td>
