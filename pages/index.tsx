...
export default function Home() {
  return (
    <Layout>
      ...
      <section
        className="bg-no-repeat bg-cover md:h-[800px] px-4 py-12 lg:py-0"
        style={{
      ...
      <div className="max-w-4xl mx-auto -mt-[60px]">
        <div className="grid md:grid-cols-2 items-center gap-8 bg-[#040ECE] p-12 rounded-lg">
          <div>
            <h2 className="text-[28px] font-light tracking-tighter text-white">
          ...
          <div className="mt-8 md:mt-0 text-right">
            <a
              href="#"
              className="whitespace-nowrap flex md:inline-flex items-center justify-center px-[20px] py-[15px] border border-transparent rounded-md shadow-[0px 4px 15px rgba(3, 7, 108, 0.2);] text-base font-medium text-[#030CAF] space-x-2 bg-white hover:bg-opacity-90"
            >
              <svg
                width="18"
                height="18"
